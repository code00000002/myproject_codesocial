package com.codesocial.qa.service;

import com.codesocial.qa.dao.ProblemDao;
...
public class ProblemService {
	 ...
	 * @return
	 */
	public Page<Problem> findNewest(String label, int page, int size) {
		Pageable pageable = PageRequest.of(page-1, size);
		return problemDao.findNewest(label,pageable);
	}
	 ...
	 * @return
	 */
	public Page<Problem> findHotest(String label, int page, int size) {
		Pageable pageable = PageRequest.of(page-1, size);
		return problemDao.findHotest(label,pageable);
	}
	 ...
	 * @return
	 */
	public Page<Problem> findWaitest(String label, int page, int size) {
		Pageable pageable = PageRequest.of(page-1, size);
		return problemDao.findWaitest(label,pageable);
	}
}
