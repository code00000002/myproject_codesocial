package com.codesocial.article.service;

import com.codesocial.article.dao.ArticleDao;
...
public class ArticleService {
	...
	public Article findById(String id) {
		...
		if (article == null){ //如果缓存没有，就从数据库查，并且存入缓存
	 ...
	 */
	@Transactional
    public void updateExamine(String articleId) {
		articleDao.updateExamine(articleId);
    }
