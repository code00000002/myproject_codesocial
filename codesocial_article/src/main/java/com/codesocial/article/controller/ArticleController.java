package com.codesocial.article.controller;

import com.codesocial.article.pojo.Article;
import com.codesocial.article.service.ArticleService;
...
public class ArticleController {
	...
	public Result updateExamine(@PathVariable("articleId") String articleId){
		articleService.updateExamine(articleId);
