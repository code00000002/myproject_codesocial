package com.codesocial.recruit.controller;
...
import com.codesocial.recruit.service.RecruitService;
...
public class RecruitController {
	...
	public Result findRecommend(){
		List<Recruit> list = recruitService.findRecommend();
		return Result.success("查询推荐职位列表成功", list);
	}
	...
	public Result findNewest(){
		List<Recruit> list = recruitService.findNewest();
		return Result.success("查询最新职位列表成功", list);
	}
}
