...
import com.codesocial.recruit.pojo.Enterprise;
import com.codesocial.recruit.service.EnterpriseService;
...
public class EnterpriseController {
	...
	public Result findIshot(){
		List<Enterprise> list = enterpriseService.findTop1Ishot();
		return Result.success("查询热门企业成功", list);
	}
